...
namespace csharp {	
	...
	public:
		...
		static std::unique_ptr<Screen> FromPoint(Point const& point);
		static std::unique_ptr<Screen> FromRectangle(Rectangle const& rectangle);
		static std::unique_ptr<Screen> FromHandle(intptr_t hwnd);
